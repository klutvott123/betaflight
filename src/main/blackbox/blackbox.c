...
static bool blackboxWriteSysinfo(void)
{
    ...
    switch (xmitState.headerIndex) {
        ...
        BLACKBOX_PRINT_HEADER_LINE("ff_averaging", "%d",                    currentPidProfile->ff_averaging);
        ...
        BLACKBOX_PRINT_HEADER_LINE("rc_smoothing_cutoffs", "%d, %d",        rcSmoothingData->setpointCutoffSetting,
                                                                            ...
                                                                            rcSmoothingData->throttleCutoffSetting);
        BLACKBOX_PRINT_HEADER_LINE("rc_smoothing_auto_factor_RPY", "%d",    rcSmoothingData->autoSmoothnessFactorSetpoint);
