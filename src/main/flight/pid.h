...
typedef enum ffAveraging_e {
    FF_AVERAGING_OFF,
    FF_AVERAGING_2_POINT,
    FF_AVERAGING_3_POINT,
    FF_AVERAGING_4_POINT,
} ffAveraging_t;
...
typedef struct pidProfile_s {
    ...
    uint8_t ff_averaging;                   // Number of packets to average when averaging is on
