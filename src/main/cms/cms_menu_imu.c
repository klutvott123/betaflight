...
static uint8_t cmsx_ff_averaging;
...
#ifdef USE_FEEDFORWARD
    cmsx_ff_averaging = pidProfile->ff_averaging;
...
#ifdef USE_FEEDFORWARD
    pidProfile->ff_averaging = cmsx_ff_averaging;
...
#ifdef USE_FEEDFORWARD
    { "FF MODE",       OME_TAB,    NULL, &(OSD_TAB_t)    { &cmsx_ff_averaging,         4, lookupTableFfAveraging}, 0 },
